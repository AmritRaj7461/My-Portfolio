  ...
  return (
    <section ref={sectionRef} id="contact" className="relative min-h-screen py-24 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="text-center mb-16 z-10">
        <h2 className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-white/10 opacity-20 select-none absolute top-20 left-1/2 -translate-x-1/2 pointer-events-none uppercase">
          Contact
        </h2>
